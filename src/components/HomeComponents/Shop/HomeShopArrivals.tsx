...
export default function HomeShopArrivals() {
  ...
  const {inViewPort: itemsInView, ref: itemRef} = useAnimation()
  const itemsAnimation = itemsInView && "animate-element__delay-2s"
  ...
  return (
    <>
      <section className="max-w-[1300px] mx-auto relative">
        <div className={`flex flex-wrap my-[60px] ${itemsAnimation}`} ref={itemRef}>
